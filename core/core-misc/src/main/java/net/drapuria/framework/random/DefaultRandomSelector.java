...
/*
    @author https://github.com/lucko
 */
@MavenDependency(groupId = "com.flowpowered", artifactId = "flow-math", version = "1.0.0")
final class DefaultRandomSelector<E> implements RandomSelector<E> {
    ...
    static <E> RandomSelector<E> uniform(Collection<E> elements) {
        ...
        return new DefaultRandomSelector<>(array, new BoundedRandomSelector(size));
    }
    ...
    static <E> RandomSelector<E> weighted(Collection<E> elements, Weigher<? super E> weigher) {
        ...
        return new DefaultRandomSelector<>(elementArray, new WeightedSelector(probabilities));
    }

    private final E[] elements;
    private final IndexSelector selection;

    private DefaultRandomSelector(E[] elements, IndexSelector selection) {
