...
//@CommandMapImpl
public class DrapuriaCommandMap_1_20 extends CraftCommandMap implements ICommandMap {

    private final BukkitCommandProvider commandProvider;
    private final DrapuriaTabCompletion tabCompletion;
    public DrapuriaCommandMap_1_20(Server server, BukkitCommandProvider commandProvider) {
        super(server);
