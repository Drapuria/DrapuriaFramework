...
public class LanguageResource {
    ...
    public LanguageString find(final String key) {
        return this.strings.getOrDefault(key, isDefault() ? find("drapuria.string.not.defined") : this.service.getResourceRepository().findResource(this.service.getDefaultLocale()).find(key));
    }
