...
package net.drapuria.framework.bukkit.protocol.packet.type;
...
public class PacketTypeClasses {
    ...
    public static class Status {
        public static class Client {
            ...
            public static void load() {
                if (MinecraftVersion.getVersion().newerThan(Minecraft.Version.v1_17_R1)) {
                    PREFIX  = "net.minecraft.network.protocol.status.";
                }
                else {
                    PREFIX = MinecraftVersion.getVersion().getNmsPackage() + ".";
                }
        ...
        public static class Server {
            ...
            public static void load() {
                if (MinecraftVersion.getVersion().newerThan(Minecraft.Version.v1_17_R1)) {
                    ...
                    PREFIX = MinecraftVersion.VERSION.getNmsPackage() + ".";
                }
    ...
    public static class Login {
        public static class Client {
            ...
            public static void load() {
                ...
                if (MinecraftVersion.getVersion().newerThan(Minecraft.Version.v1_13_R1)) {
