...
public class NPCProfile {
    ...
    public NPCProfile(@NotNull UUID uniqueId) {
        this(uniqueId, null);
    }

    public NPCProfile(@NotNull UUID uniqueId, Collection<Property> properties) {
        this(uniqueId, null, properties);
    }

    public NPCProfile(@NotNull String name) {
        this(name, null);
    }

    public NPCProfile(@NotNull String name, Collection<Property> properties) {
    ...
    public Collection<Property> getProperties() {
        return this.properties == null ? this.properties = new HashSet<>() : this.properties;
    }
