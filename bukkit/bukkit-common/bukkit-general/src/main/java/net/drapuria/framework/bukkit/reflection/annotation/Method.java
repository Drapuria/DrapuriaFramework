...
package net.drapuria.framework.bukkit.reflection.annotation;
...
/**
 * Resolves the annotated {@link net.drapuria.framework.bukkit.reflection.resolver.wrapper.MethodWrapper} or {@link java.lang.reflect.Method} field to the first matching method name.
 */
