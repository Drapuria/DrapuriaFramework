...
public class Query {
    ...
    public Query insert(Object row) {
        ...
        args = sqlStatementBuilder.getInsertArguments(this, row);
            ...
            if (resultSet.next()) {
                if (isMap) {
                    ...
                    for (String generatedKeyName : generatedKeyNames) {
                        ...
                        if (prop == null) {
                            throw new SqlDatabaseException("Generated key name not found: " + generatedKeyName);
                        }
                        ...
                        Class<?> type = SQLUtil.wrapPrimitive(prop.getDataType());
    ...
    public Query delete(Object row) {
        ...
        args = sqlStatementBuilder.getDeleteArguments(this, row);
    ...
    public Query delete() {
        ...
        if (table == null) {
            throw new SqlDatabaseException("You must specify a table name with the table() method.");
        }
