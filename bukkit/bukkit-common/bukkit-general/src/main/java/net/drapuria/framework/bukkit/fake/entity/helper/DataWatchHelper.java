package net.drapuria.framework.bukkit.fake.entity.helper;
...
@UtilityClass
public class DataWatchHelper {

    public WrappedDataWatcher createDefaultWatcher(LivingFakeEntity entity) {
        WrappedDataWatcher data = new WrappedDataWatcher();
        addEntityDefaults(data, entity.getEntityType());
    ...
    @SuppressWarnings("DuplicateBranchesInSwitch") // we want them to be clear ig
    public void addEntityDefaults(WrappedDataWatcher watcher, EntityType type) {
        ...
        switch (type) {
            ...
            case SLIME:
            case MAGMA_CUBE:
                watcher.setObject(16, (byte) 4); //Slime size 1
                break;
            case OCELOT:
